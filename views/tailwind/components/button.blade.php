...
@php
    ...
    $focusClass = 'focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-brand-500';
    ...
    $classes = "inline-flex {$sizeClass} {$textClass} {$focusClass} {$colorClass} font-medium shadow-sm";
@endphp
